...
export default function BusinessCard({ business }: Props) {
  ...
  const allButtons = [
    ...
    business.google_place_id ? (
      <a key="google" href={`https://search.google.com/local/reviews?placeid=${business.google_place_id}`} target="_blank" rel="noreferrer" style={{ ...btnBase, textDecoration:'none', border:'none' }}>
