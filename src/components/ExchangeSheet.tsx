// ─────────────────────────────────────────────
// ExchangeSheet.tsx
// src/components/ExchangeSheet.tsx
// ─────────────────────────────────────────────
import { Icon } from '@iconify/react'
import ExchangeWidget from '../pages/ExchangeWidget'

export default function ExchangeSheet({ onClose }: { onClose: () => void }) {
  return (
    <>
      ...
      <div style={{
        ...
        borderRadius:'20px 20px 0 0', height:'85vh', zIndex:801,
        ...
        <div style={{ flexShrink:0, display:'flex', alignItems:'center', justifyContent:'space-between', padding:'12px 16px 0' }}>
          <div style={{ fontSize:16, fontWeight:700, color:'#0D3349' }}>💱 환율 계산기</div>
        ...
        <div style={{ flex:1, overflowY:'auto', minHeight:0 }}>
          <ExchangeWidget onClose={onClose} />
        </div>
      </div>
    </>
  )
