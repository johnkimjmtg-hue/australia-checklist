// ─────────────────────────────────────────────
// NearbySheet.tsx
// src/components/NearbySheet.tsx
// ─────────────────────────────────────────────
  ...
  return (
    <>
      ...
      <div style={{
        ...
        height:'calc(100dvh - 20px)', overflowY:'hidden', zIndex:801,
        ...
        <div style={{ flexShrink:0, display:'flex', alignItems:'center', justifyContent:'space-between', padding:'12px 16px 0' }}>
          <div style={{ fontSize:16, fontWeight:700, color:'#0D3349' }}>📍 내 주변</div>
