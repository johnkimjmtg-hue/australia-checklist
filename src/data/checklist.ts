...
export const ITEMS: CheckItem[] = [
  ...
  { id:'f36', categoryId:'food', label:'블랙스타 페이스트리 수박 케이크', emoji:'🍰' },
  { id:'f37', categoryId:'food', label:'공원 BBQ 파티', emoji:'🔥' },
  ...
  { id:'g23', categoryId:'places', label:'하버 브릿지 클라이밍: 시드니 전경을 발밑에 두기', emoji:'🌉' },
  { id:'g24', categoryId:'places', label:'본다이 비치 선택하기', emoji:'🏄' },
  { id:'g25', categoryId:'places', label:'캥거루 먹이주기', emoji:'🦘' },
