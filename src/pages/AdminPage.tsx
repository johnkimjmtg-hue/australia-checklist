...
function GooglePlacesCollectSection({ ff }: { ff: string }) {
  ...
  const geocodePostcode = (postcode: string): Promise<{ lat: number; lng: number; label: string } | null> => {
    return new Promise(resolve => {
  ...
  return (
    <div style={{ marginBottom:24, fontFamily: ff }}>
      ...
      <div style={{ marginBottom:12 }}>
        <div style={{ fontSize:11, fontWeight:700, color:'#64748B', marginBottom:6 }}>포스트코드 입력</div>
