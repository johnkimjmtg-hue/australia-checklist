...
export default function LandingPage({ state, onStart, onServices }: Props) {
  ...
  const completed  = Object.keys(state.selected).length
      ...
      <div style={{
        ...
        <div style={{
          ...
          <div style={{ display:'flex', alignItems:'center', justifyContent:'space-between', marginBottom:12 }}>
            ...
            <span style={{ fontSize:11, color:'#94A3B8' }}>{completed}/{total} 완료</span>
          </div>
          <div style={{ width:'100%', height:4, background:'#F1F5F9', borderRadius:4, marginBottom:12, overflow:'hidden' }}>
            <div style={{ width:`${percent}%`, height:'100%', background:'linear-gradient(90deg,#003594,#0052cc)', borderRadius:4 }}/>
          </div>
