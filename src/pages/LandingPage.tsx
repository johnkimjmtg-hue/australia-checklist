  ...
  return (
    <div style={{ background:'#e8e8e8', fontFamily:ff, overflowX:'hidden' }}>
      ...
      <div style={{
        ...
        {/* ── 책상 데코 ── */}
        <div style={{
          position:'relative', marginTop:16, height:200,
          width:'100%', maxWidth:380, pointerEvents:'none',
        }}>
          <style>{`
            .deco-note {
              position:absolute; left:170px; bottom:30px;
              width:180px; height:130px;
              background:#fff8dc; borderRadius:10px;
              transform:rotate(-3deg);
              box-shadow:0 8px 20px rgba(0,0,0,0.12);
              padding:12px; boxSizing:border-box;
              font-size:11.5px; lineHeight:1.7;
            ...
            .deco-pencil {
              ...
              background:linear-gradient(90deg,#f4c542 82%,#c8a060 82%,#c8a060 88%,#222 88%);
            ...
            .deco-pencil::after {
              ...
              border-left:9px solid #f4d080;
              border-top:8px solid transparent;
              border-bottom:8px solid transparent;
            }
            .deco-pen {
              position:absolute; left:100px; bottom:14px;
              width:115px; height:7px;
              background:linear-gradient(90deg,#1a1a2e 70%,#888 70%,#888 80%,#ccc 80%);
            ...
            .deco-eraser {
              position:absolute; left:68px; bottom:68px;
              width:46px; height:22px;
              background:#f7b5c0;
              borderRadius:5px;
              transform:rotate(-8deg);
              boxShadow:inset 0 0 4px rgba(0,0,0,0.08), 2px 2px 4px rgba(0,0,0,0.1);
            }
            .deco-calendar {
            ...
            .deco-calendar-header {
              background:#e8534a;
              height:26px;
              display:flex; alignItems:center; justifyContent:center;
              fontSize:11px; fontWeight:800; color:#fff; letterSpacing:1px;
            }
            .deco-calendar-body {
              padding:4px 0 0;
              textAlign:center;
            ...
            .deco-calendar-day {
              fontSize:28px; fontWeight:800; color:#1a1a2e; lineHeight:1.1;
            }
            .deco-calendar-week {
              fontSize:9px; color:#888; marginTop:2px;
            }
            .deco-calendar-dots {
              display:flex; justifyContent:center; gap:3px; marginTop:6px;
            }
            .deco-crumpled {
              position:absolute; right:8px; bottom:8px;
              width:38px; height:38px;
              background:#e8e8e4; borderRadius:50%;
              boxShadow:inset -3px -3px 5px rgba(0,0,0,0.1), inset 3px 3px 5px rgba(255,255,255,0.7);
            }
          `}</style>

          {/* 연필 */}
          <div className="deco-pencil" />

          {/* 볼펜 */}
          <div className="deco-pen" />

          {/* 지우개 */}
          <div className="deco-eraser" />

          {/* 메모지 */}
          <div className="deco-note">
            <div style={{ fontWeight:700, marginBottom:4, fontSize:12 }}>호주 가기 전 체크 ✏️</div>
            <div>✔ 비자 신청하기</div>
            <div>✔ 항공권 예약</div>
            <div style={{ color:'#aaa' }}>☐ 숙소 예약하기</div>
            <div style={{ color:'#aaa' }}>☐ 쇼핑리스트 작성</div>
            <div style={{ color:'#1B6EF3', fontSize:10, marginTop:4 }}>← hojugaja.com 👆</div>
          </div>

          {/* 달력 */}
          <div className="deco-calendar">
            <div className="deco-calendar-header">MAR</div>
            <div className="deco-calendar-body">
              <div className="deco-calendar-day">20</div>
              <div className="deco-calendar-week">THURSDAY</div>
              <div className="deco-calendar-dots">
                {[1,2,3,4,5].map(i => (
                  <div key={i} style={{ width:5, height:5, borderRadius:'50%', background: i<=3 ? '#e8534a' : '#e0e0e0' }} />
                ))}
              </div>
            </div>
          </div>
