...
export default function LandingPage({ onComplete }: Props) {
  ...
  return (
    <div style={{
      minHeight: '100dvh', background: '#FFF8F3', fontFamily: ff,
      ...
      <div style={{ padding:'20px 18px 0', display:'grid', gridTemplateColumns:'1fr 1fr', gap:10 }}>
        {[
          ...
          <div key={i} style={{ background:'#fff', borderRadius:16, padding:'12px 14px', border:'0.5px solid #f0e8e0' }}>
      ...
      {/* ── 피커 시트 */}
      {picker === 'year' && (
        <div style={{ margin:'12px 18px 0', background:'#fff', borderRadius:16, padding:14, border:'0.5px solid #f0e8e0', display:'grid', gridTemplateColumns:'repeat(3,1fr)', gap:8 }}>
      ...
      {picker === 'month' && (
        <div style={{ margin:'12px 18px 0', background:'#fff', borderRadius:16, padding:14, border:'0.5px solid #f0e8e0', display:'grid', gridTemplateColumns:'repeat(4,1fr)', gap:8 }}>
          {MONTHS.map((m, i) => (
