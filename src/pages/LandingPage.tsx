    ...
    <div style={{
      ...
      <div style={{ padding:'20px 18px 0', display:'grid', gridTemplateColumns:'1fr 1fr', gap:10 }}>
        {[
          ...
          <div key={i} style={{ background:'rgba(255,255,255,0.55)', borderRadius:16, padding:'12px 14px', border:'0.5px solid rgba(255,255,255,0.4)', backdropFilter:'blur(8px)' }}>
      ...
      {/* ── 피커 시트 */}
      {picker === 'year' && (
        <div style={{ margin:'12px 18px 0', background:'rgba(255,255,255,0.6)', borderRadius:16, padding:14, border:'0.5px solid rgba(255,255,255,0.4)', display:'grid', gridTemplateColumns:'repeat(3,1fr)', gap:8, backdropFilter:'blur(8px)' }}>
      ...
      {picker === 'month' && (
        <div style={{ margin:'12px 18px 0', background:'rgba(255,255,255,0.6)', borderRadius:16, padding:14, border:'0.5px solid rgba(255,255,255,0.4)', display:'grid', gridTemplateColumns:'repeat(4,1fr)', gap:8, backdropFilter:'blur(8px)' }}>
          {MONTHS.map((m, i) => (
      ...
      {/* ── 달력 */}
      <div style={{ margin:'12px 18px 0', background:'rgba(255,255,255,0.6)', borderRadius:22, border:'0.5px solid rgba(255,255,255,0.4)', overflow:'hidden', backdropFilter:'blur(8px)' }}>
