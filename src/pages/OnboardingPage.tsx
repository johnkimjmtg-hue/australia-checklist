      ...
      <div style={{
        ...
        <div style={{
            ...
            <div style={{ width: '100%', maxWidth: 360, animation: 'fadeUp 0.4s ease 0.1s both' }}>
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: spacing[3] }}>
                  <button
                    ...
                    style={{
                      ...
                      gap: spacing[2],
                      background: loading ? colors.gray100 : colors.bgCard,
                      border: `1px solid ${colors.border}`,
                      borderRadius: radius.md,
                      fontSize: font.size.md, fontWeight: font.weight.bold,
                      fontFamily: font.family, color: '#3C4043',
                  ...
                  <button
                    ...
                    style={{
                      ...
                      color: colors.textTertiary, fontSize: font.size.sm,
                      cursor: 'pointer', padding: `${spacing[1]}px 0`,
              ...
              {mode === 'login' && (
                <div style={{ display: 'flex', flexDirection: 'column', gap: spacing[3] }}>
                  ...
                  {error && (
                    <div style={{
                      ...T.sm, color: colors.danger, background: colors.dangerLight,
                      borderRadius: radius.sm, padding: `${spacing[2]}px ${spacing[3]}px`,
                    }}>{error}</div>
                  )}
              ...
              {mode === 'signup' && (
                <div style={{ display: 'flex', flexDirection: 'column', gap: spacing[3] }}>
                  ...
                  <Input type="text" placeholder="이름 (닉네임)" value={name} onChange={setName} />
                  <Input type="email" placeholder="이메일" value={email} onChange={setEmail} />
                  <Input type="password" placeholder="비밀번호 (6자 이상)" value={password} onChange={setPassword} />
                  {error && (
                    <div style={{
                      ...T.sm, color: colors.danger, background: colors.dangerLight,
                      borderRadius: radius.sm, padding: `${spacing[2]}px ${spacing[3]}px`,
          ...
          <div style={{
            ...
            <div style={{ ...T.xs, color: colors.textTertiary, lineHeight: 1.7 }}>
              계속 진행하면{' '}
              <button
